...
import sprb_irrigation_update as irr
...
for i in range(1950,2013):
    ...
    Hydrologic_Year_Irrigation_Shortfalls_Historical_StateMod[i].plot(column='CROP_TYPE', categorical=True, cmap='jet', linewidth=.2, edgecolor='0.4',

...
for y in range(1950,2013):
    ...
    if y in CBI_S2.index:
        ...
        old.TWO_Selection[y]['TWO_BASELINE_SCENARIO_MV'] = old.TWO_Selection[y]['TWO_USAGE']*max_mv
...
exercise_fees = [5, 7.5, 10, 12.5, 25]
...
Northern_Demand = (Longmont_Total_demand_Sum + Loveland_Total_demand_Sum + Louisville_Total_demand_Sum + Laffayette_Total_demand_Sum + Boulder_Total_demand_Sum)
...
twin1.set_ylabel('CBI', color = color5, fontsize=20, fontname='Myriad Pro') 
...
ax1.text(-.15, 0.50, 'Water Re-allocated (kAF)', ha='center', va='center', transform=ax1.transAxes, rotation='vertical', color = 'black', fontsize=20, fontname='Myriad Pro')
...
plt.ylim([-0.9,2.3])
ax2.text(-.15, .5, 'Ag Gains/Losses ($M)', ha='center', va='center', transform=ax2.transAxes, rotation='vertical', color = 'black', fontsize=20, fontname='Myriad Pro')
...
#plt.show()
plt.savefig('TWO_historical_S1_hi_res.png', format = 'png', dpi=600, bbox_inches='tight')
...
# data_5 = dry_year_two_cost_sum/1000000
# data_6 = wet_year_two_cost_sum/1000000
# plt.bar(x, data_6, color = color1) 
# plt.bar(x, -(data_5), color = color2)
# plt.ylim([-.7,.7])
...
# plt.xlabel('Year', fontsize=20, fontname='Myriad Pro') # Add this line
# #plt.ylabel('TWO Cost ($)')
# ax3.text(-.11, .75, 'Ag', ha='center', va='center', transform=ax3.transAxes, rotation='vertical', color = color1, fontsize = 20, fontname='Myriad Pro')
# ax3.text(-.11, .25, 'Urban', ha='center', va='center', transform=ax3.transAxes, rotation='vertical', color = color2, fontsize = 20, fontname='Myriad Pro')
# ax3.text(-.15, 0.45, 'Two-Way Option Cost ($M)', ha='center', va='center', transform=ax3.transAxes, rotation='vertical', color = 'black', fontsize=20, fontname='Myriad Pro')
# plt.subplots_adjust(hspace=0.4)
...
#plt.savefig('TWO_historical_S1_manuscript_hi_res.png', format = 'png', dpi=300)

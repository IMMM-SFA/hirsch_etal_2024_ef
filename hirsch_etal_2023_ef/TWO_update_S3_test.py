...
for y in range(1950,2013):
    ...
    if y in CBI_S2.index:
        ...
        new.TWO_Selection[y]['TWO_BASELINE_SCENARIO_MV'] = new.TWO_Selection[y]['TWO_USAGE']*ag_max_rev_price
...
#plt.show()
plt.savefig('TWO_update_S3_hi_res.png', format = 'png', dpi=600, bbox_inches='tight')

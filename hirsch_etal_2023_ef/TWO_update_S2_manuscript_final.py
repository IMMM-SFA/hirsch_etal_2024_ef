...
# ax1.text(-.1, 0.75, 'Wet Years', ha='center', va='center', transform=ax1.transAxes, rotation='vertical', color = 'blue', weight = 'bold', fontsize=20)
# ax1.text(-.1, 0.25, 'Dry Years', ha='center', va='center', transform=ax1.transAxes, rotation='vertical', color = 'red', weight = 'bold', fontsize=20)
...
# ax2.bar(x, y2, bottom = y1, color = 'orange', label = 'Increased Irrigation')
# ax2.bar(x, y1, color = 'green', label = 'TWO Revenue')
# plt.ylim([-0.7,2])
# ax2.text(-.15, .5, 'Ag Net Benefits ($M)', ha='center', va='center', transform=ax2.transAxes, rotation='vertical', color = 'green', weight = 'bold', fontsize=20)
# for label in ax2.get_yticklabels()[0:7]:
...
# ax3 = plt.subplot(3, 1, 3, sharex = ax1)
# data_5 = dry_year_two_cost_sum/100000
# data_6 = wet_year_two_cost_sum/100000
...
#     label.set_color("blue")
# # set labels to absolute values and with integer representation
# ax3.set_yticklabels([(abs(tick)) for tick in ticks], fontsize=20, weight = 'bold')
...
# ax3.text(-.15, 0.45, 'Two-Way Option Cost ($100K)', ha='center', va='center', transform=ax3.transAxes, rotation='vertical', color = 'black', weight = 'bold', fontsize=20)

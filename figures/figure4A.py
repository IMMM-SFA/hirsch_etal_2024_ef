...
ax2.plot(Loveland_Total_demand_Sum['demand']*af_to_m3/1000000,color=color1, label='Loveland', linewidth = 2.5)
ax2.plot(Longmont_Total_demand_Sum['demand']*af_to_m3/1000000,color=color2, label='Longmont', linewidth = 2.5)
ax2.plot(Louisville_Total_demand_Sum['demand']*af_to_m3/1000000,color=color3, label='Louisville', linewidth = 2.5)
ax2.plot(Laffayette_Total_demand_Sum['demand']*af_to_m3/1000000,color=color4, label='Lafayette', linewidth = 2.5)
ax2.plot(Boulder_Total_demand_Sum['demand']*af_to_m3/1000000,color=color5, label='Boulder', linewidth = 2.5)
ax2.set_yticklabels(ax2.get_yticklabels()[1:8])
ax2.set_xticklabels(ax2.get_xticklabels(), rotation=0)
ax2.text(-.08, .5, 'Demand (MCM)', ha='center', va='center', transform=ax2.transAxes, rotation='vertical', color = 'black', fontsize = 10)
ax2.text(.5, -.09, 'Year', ha='center', va='center', transform=ax2.transAxes, color = 'black', fontsize = 10)
plt.ylim([0,33])
...
plt.savefig('figure_4A_northern_water_observed_demands_hi_res.png', format = 'png', dpi=600, bbox_inches='tight')
# plt.figure()
# plt.plot(Boulder_Cum_Sum)
...
plt.figure()
plt.scatter(Boulder_Surplus_Percent, CBI_Yearly_Selection)

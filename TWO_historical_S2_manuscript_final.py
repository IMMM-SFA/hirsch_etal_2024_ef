...
# need to change directory to where the Lake Granby Parquet file is located
...
for y in range(1950,2013):
    ...
    if y in CBI_S2.index:
        ...
        ###THIS IS THE MARKET CLEARING PRICE USED IN THIS SCENARIO######
...
for i in (old.TWO_Selection_Wet[y].index.unique()):
    ...
    for y in range(1950,2013):
        contracts_wet = old.TWO_Selection_Wet[y].loc[old.TWO_Selection_Wet[y].index== i]

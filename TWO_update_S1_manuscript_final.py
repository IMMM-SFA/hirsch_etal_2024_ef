...
for y in range(1950,2013):
    ...
    if y in CBI_S2.index:
        ...
        ## this is where you change the pricing scenario ####
...
ax1.plot(dry_year_option_timeseries[5]/1233.4818375, label = f"Dry Year Option with $0.004 Exercise Fee", linewidth = 2, color = color1)
ax1.plot(dry_year_option_timeseries[15]/1233.4818375, label = f"Dry Year Option with $0.01 Exercise Fee", linewidth = 2, color = color7)
ax1.set_ylim(ymin=0)
ax1.set_ylim(ymax=0.05)
ax1.set_yticklabels(ax1.get_yticklabels())
ax1.set_xticklabels(ax1.get_xticklabels(), rotation=0)
ax1.text(-.11, .5, 'Cost (\\$/($m^{3}$)', ha='center', va='center', transform=ax1.transAxes, rotation='vertical', color = 'black', fontsize = 10)
ax1.text(.5, -.1, 'Hydrologic Year', ha='center', va='center', transform=ax1.transAxes, color = 'black', fontsize = 10)
legend_prop = {'weight': 'bold'}
ax1.legend()
# plt.savefig('TWO_Dry_Year_option_ex.png', format = 'png', dpi=600, bbox_inches='tight')
#ax1.legend(bbox_to_anchor=(1, 1), loc='upper right', borderaxespad=0, frameon = False, framealpha = 0.5)

# plt.figure()
# for e in [5,15]:
#     ax1 = plt.subplot()
#     plt.style.use('default')
#     ax1.plot(dry_year_option_timeseries[e], label = f"Dry Year Option with ${e} Exercise Fee", linewidth = 2)
#     ax1.set_ylim(ymin=0)
#     ax1.set_ylim(ymax=40)
#     ax1.set_yticklabels(ax1.get_yticklabels())
#     ax1.set_xticklabels(ax1.get_xticklabels(), rotation=0)
#     ax1.text(-.1, .5, 'Cost ($/AF)', ha='center', va='center', transform=ax1.transAxes, rotation='vertical', color = 'black', fontsize = 10)
#     ax1.text(.5, -.1, 'Hydrologic Year', ha='center', va='center', transform=ax1.transAxes, color = 'black', fontsize = 10)
#     ax1.legend(bbox_to_anchor=(1.75, 1), loc='upper right', borderaxespad=0, frameon = False, framealpha = 0.5)
...
ax1 = plt.subplot()
plt.style.use('default')
ax1.plot(wet_year_option_timeseries_mv30[5]/1233.4818375, label = f"Wet Year Option with $0.004 Exercise Fee", linewidth = 2, color = color1)
ax1.plot(wet_year_option_timeseries_mv30[25]/1233.4818375, label = f"Wet Year Option with $0.02 Exercise Fee", linewidth = 2, color = color7)
ax1.set_ylim(ymin=0)
ax1.set_ylim(ymax=0.05)
ax1.set_yticklabels(ax1.get_yticklabels())
ax1.set_xticklabels(ax1.get_xticklabels(), rotation=0)
...
legend_prop = {'weight': 'bold'}
ax1.legend()
plt.savefig('TWO_Wet_Year_option_ex.png', format = 'png', dpi=600, bbox_inches='tight')

# plt.figure()
# for e in [5,25]:
#     ax1 = plt.subplot()
#     plt.style.use('default')
#     ax1.plot(wet_year_option_timeseries_mv30[e], label = f"Wet Year Option with ${e} Exercise Fee", linewidth = 2)
#     ax1.set_ylim(ymin=0)
#     ax1.set_ylim(ymax=40)
#     ax1.set_yticklabels(ax1.get_yticklabels())
#     ax1.set_xticklabels(ax1.get_xticklabels(), rotation=0)
...
#plt.show()
plt.savefig('TWO_update_S1_hi_res.png', format = 'png', dpi=600, bbox_inches='tight')

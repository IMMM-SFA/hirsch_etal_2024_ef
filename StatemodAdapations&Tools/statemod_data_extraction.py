...
class StateModDataExtractor:
    ...
    def __init__(
        ...
        self.carried_column = 14
        self.carried_column_name = 'carried'
        self.carried_column_type = np.uint32
        self.priority_column = 6
        self.priority_column_name = 'river-priority'
        self.priority_column_type = np.uint32
        self.storage_column = 7
        self.storage_column_name = 'river-storage'
        self.storage_column_type = np.uint32
        self.other_column = 8
        self.other_column_name = 'river-other'
        self.other_column_type = np.uint32
        self.carrierpriority_column = 11
        self.carrierpriority_column_name = 'carrier-priority'
        self.carrierpriority_column_type = np.uint32
        self.carrierother_column = 12
        self.carrierother_column_name = 'carrier-other'
        self.carrierother_column_type = np.uint32
        self.gw_column = 10
        self.gw_column_name = 'from well'
        self.gw_column_type = np.uint32
        self.soilmoisture_column = 15
        self.soilmoisture_column_name = ' from soil moisture'
        self.soilmoisture_column_type = np.uint32
        self.returnflow_column = 25
        self.returnflow_column_name = 'returnflow'
        self.returnflow_column_type = np.uint32
        ...
        self.expected_column_sizes = np.asarray([
            12, 12, 5, 5, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 13, 12
        ])
    ...
    def parse_xdd_file(self, file_path: str) -> bool:
                        ...
                        stream.write(
                            ','.join(
                                [data[i] for i in [
                                    ...
                                    self.storage_column,
                                    self.other_column,
                                    self.carrierpriority_column,
                                    self.carrierother_column,
                                    self.gw_column,
                                    self.soilmoisture_column,
                                    self.returnflow_column
                                ]]
                            )
                        )
                        stream.write('\n')
        ...
        df = pd.read_csv(
            ...
            names=[
                ...
                self.carried_column_name,
                self.priority_column_name,
                self.storage_column_name,
                self.other_column_name,
                self.carrierpriority_column_name,
                self.carrierother_column_name,
                self.gw_column_name,
                self.soilmoisture_column_name,
                self.returnflow_column_name
            ],
            dtype={
                ...
                self.carried_column_name: self.carried_column_type,
                self.priority_column_name: self.priority_column_type,
                self.storage_column_name: self.storage_column_type,
                self.other_column_name: self.other_column_type,
                self.carrierpriority_column_name: self.carrierpriority_column_type,
                self.carrierother_column_name: self.carrierother_column_type,
                self.gw_column_name: self.gw_column_type,
                self.soilmoisture_column_name: self.soilmoisture_column_type,
                self.returnflow_column_name: self.returnflow_column_type
            }
        )
